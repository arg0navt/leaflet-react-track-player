...
L.Polyline.include({
  ...
  _snakeForward: function(forward) {
    ...
    if (this._play && this._map) {
      ...
      if (this._latLngAnimation) {
        ...
        if (this._eventParents[i[0]]._options === "distance") {
          this.latLngAnimation({
            e: headLatLng,
  ...
  _nextPoint: function() {
    ...
    if (this._eventParents[i[0]]._options.progressFormat === "default") {
...
L.LayerGroup.include({
  ...
  procentProgress: function(e, point, progress) {
    if (progress) {
      ...
      var resultDistance =
        prevRangeColors + activePolylineRange + progress.distance;
