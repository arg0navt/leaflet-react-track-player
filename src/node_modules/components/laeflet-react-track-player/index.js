...
class LeafletReactTrackPlayer extends MapLayer {
    constructor(props) {
        ...
        this.state = {
            ...
            track: [],
            active: true,
            activeTimeOrIndex: props.playerAndTime ? props.track[0].t : 0,
        ...
        this.leafletElement.snakePolyline.snakeIn({
            ...
            nextPoint: (point, index) => {
                ...
                if (this.props.playerAndTime) {
                    ...
                    this.setState({activePosition: (index / this.props.track.length) * 100})
                }
            ...
            finish: (lastPosition) => {
                ...
                if (lastPosition) {
                    this.setState({ 
                        active: false, 
                        activeTimeStamp: this.props.playerAndTime ? this.props.track[this.props.track.length - 1].t : this.props.track.length - 1, 
                        activePosition: 100 
                    });
