...
class LeafletReactTrackPlayer extends MapLayer {
    ...
    changeActivePosition = (e) => {
        ...
        if (this.props.playerAndTime) {
            ...
            this.leafletElement.snakePolyline.changePositionTime(activePositionTime.format(this.props.timeFormat), true);
        } else {
            const indexPoint = Number((activePosition * (this.props.track.length / 100)).toFixed());
            this.leafletElement.snakePolyline.changePositionTime(indexPoint);
        }
    }
