                    ...
                    <div className="tp_track-line">
                        ...
                        <div className="tp_track-points" ref={(e) => { this.pointsLine = e }}>
                            {this.props.track.map((item, index) => {
                                const itemDuration = moment(this.props.track[this.props.track.length - 1].t, "YYMMDDHHmmss000") - moment(item.t, "YYMMDDHHmmss000");
                                const procent = itemDuration / (durationTrack / 100);
