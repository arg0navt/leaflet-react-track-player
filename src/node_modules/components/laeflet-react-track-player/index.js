...
class LeafletReactTrackPlayer extends MapLayer {
  ...
  updateLeafletElement(fromProps, toProps){
    if (fromProps.track.length !== toProps.track.length) {
      if (this.props.progressFormat === "default" || this.props.progressFormat === "distance") {
        const newPointsPolyline = L.multiOptionsPolyline(toProps.track.slice(fromProps.track.length - 1), {
          multiOptions: {
            optionIdxFn: this.props.optionMultyIdxFn
              ? this.props.optionMultyIdxFn
              : function() {},
