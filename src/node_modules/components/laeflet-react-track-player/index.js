...
class LeafletReactTrackPlayer extends MapControl {
    ...
    changeActivePosition = (e) => {
        ...
        this.setState({
            ...
            this.leafletElement.snakePolyline.newPosition(activePositionTime.format("YYMMDDHHmmss000"));
        })
    }
    tooglePlay = () => {
        this.setState({
    ...
    createLeafletElement() {
        ...
        snakePolyline.snakeIn(
            (e) => finishMarker.setLatLng(e), 
            (point) => finishMarker.setIcon(createIcon(point.course)),
            () => this.setState({active: false})
        );
        snakePolyline.on('snakestart snake snakeend', function(ev){
